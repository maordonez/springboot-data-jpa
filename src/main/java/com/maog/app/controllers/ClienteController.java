...
import com.maog.app.models.service.IUploadFileService;
import com.maog.app.util.paginator.PageRender;
...
public class ClienteController {
	...
	public ResponseEntity<Resource> verFoto(@PathVariable String filename){
		...
		return ResponseEntity.ok()
				.header(HttpHeaders.CONTENT_DISPOSITION, "attachment=\""+recurso.getFilename()+"\"")
				.body(recurso);
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model,
		...
		if (!foto.isEmpty()) {
			...
			String name =uploadService.copy(foto);
